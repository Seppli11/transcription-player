...
pub const RUBBERBAND_VERSION: &[u8; 6usize] = b"3.3.0\0";
pub const RUBBERBAND_API_MAJOR_VERSION: u32 = 2;
pub const RUBBERBAND_API_MINOR_VERSION: u32 = 8;
...
pub type RubberBandOption = ::std::os::raw::c_uint;
...
extern "C" {
    pub fn rubberband_get_process_size_limit(arg1: RubberBandState) -> ::std::os::raw::c_uint;
}
extern "C" {
